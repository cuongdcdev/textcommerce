		...
		echo "<div id='shippingRates' style='display:none;' class='settingsRegion'>".
          ...
          $weight = lbs;
							...
							echo '<table cellpadding="0" cellspacing="0" border="0"><tr><td style="width:150px;"><input type="text" value="'.$rate['title'].'" name="title"/></td>'.
									 ...
									 n.'<td valign="center" style="width:130px;padding:0;"><input type="text" name="start_weight" value="'.$rate['start_weight'].'" style="width:25px;"/> '.$weight.' - <input type="text" name="end_weight" value="'.$rate['end_weight'].'" style="width:25px;"/>  '.$weight.' </td>'.
